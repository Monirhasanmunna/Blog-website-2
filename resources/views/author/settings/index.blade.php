                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="home_with_icon_title">
                            <div class="card" style="box-shadow: 0px 0px 0px">
                                <div class="body">
                                    <form class="form-horizontal" method="POST" action="{{route('author.settings.update',[$user->id])}}" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="row clearfix">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="profile_with_icon_title">
                            <div class="card" style="box-shadow: 0px 0px 0px">
                                <div class="body">
                                    <form class="form-horizontal" method="POST" action="{{route('author.password.update',[$user->id])}}">
                                        @method('PUT')
                                        @csrf
                                        <div class="row clearfix">
